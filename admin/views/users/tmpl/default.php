...
<form action="<?php echo JRoute::_('index.php?option=com_jombadger&view=users');?>" method="post" name="adminForm" id="adminForm">
	<fieldset id="filter-bar">
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_group_id" class="inputbox" onchange="this.form.submit()">
				...
				<?php echo JHtml::_('select.options', JombadgerHelper::getGroups(), 'value', 'text', $this->state->get('filter.group_id'));?>
			</select>
			...
			<select name="filter_range" id="filter_range" class="inputbox" onchange="this.form.submit()">
				...
				<?php echo JHtml::_('select.options', Jombadgerhelper::getRangeOptions(), 'value', 'text', $this->state->get('filter.range'));?>
			</select>
		</div>
	</fieldset>
	<div class="clr"> </div>
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			$canChange	= $loggeduser->authorise('core.edit.state',	'com_jombadger');
